...
export default function Aurelia() {
  ...
  useEffect(() => {
    fetch('/api/products?gender=Women&brand=Aurelia')
      .then(res => res.json())
      .then(data => {
        setProducts(data)
        setLoading(false)
        ...
        {!loading && !error && (
          <>
            {(activeCategory === 'All' || activeCategory === 'Dresses') && (
              <>
                <div className="section-header"><h2 className="section-title">Aurelia Dresses</h2></div>
            ...
            {(activeCategory === 'All' || activeCategory === 'Tops') && (
              <>
                <div className="section-header"><h2 className="section-title">Aurelia Tops</h2></div>
            ...
            {(activeCategory === 'All' || activeCategory === 'Jeans') && (
              <>
                <div className="section-header"><h2 className="section-title">Aurelia Jeans</h2></div>
