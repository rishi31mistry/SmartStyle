...
function FilterSidebar({ filterOpen, setFilterOpen, clearFilters,
  ...
  const brands = ['Nike', 'Adidas', 'H&M', 'Jack & Jones', 'Puma', "Levi's", 'Gap', 'U.S. Polo', 'Wrangler', 'Tommy Hilfiger']
                ...
                {filteredProducts.map(p => (
                  ...
                  >
                    <div className="product-img-wrap" style={{ height: '420px' }}>
                      ...
                      {p.tag && (
                        <span className="product-tag" style={{ background: tagColor(p.tag) }}>
                          {p.tag}
                        </span>
                      )}
                    </div>
