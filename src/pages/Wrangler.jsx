...
export default function Wrangler() {
  ...
  useEffect(() => {
    fetch('/api/products?gender=Men&brand=Wrangler')
      .then(res => res.json())
      .then(data => {
        setProducts(data)
        setLoading(false)
          ...
          {categories.map(cat => (
            <button
              ...
              style={{
                ...
                background: activeCategory === cat.name ? '#F4A100' : '#fff',
        ...
        {!loading && !error && (
          <>
            {(activeCategory === 'All' || activeCategory === 'T-Shirts') && (
              <>
                <div className="section-header"><h2 className="section-title">Wrangler T-Shirts</h2></div>
            ...
            {(activeCategory === 'All' || activeCategory === 'Shirts') && (
              <>
                <div className="section-header"><h2 className="section-title">Wrangler Shirts</h2></div>
            ...
            {(activeCategory === 'All' || activeCategory === 'Jeans') && (
              <>
                <div className="section-header"><h2 className="section-title">Wrangler Jeans</h2></div>
