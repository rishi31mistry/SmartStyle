...
function FilterSidebar({ filterOpen, setFilterOpen, clearFilters,
  ...
  const categories = ['Kurtis', 'Dresses', 'Sarees', 'Tops', 'Jeans', 'Plazzos', 'Lehengas', 'Jackets', 'Skirts', 'Ethnic Wear', 'Sportswear']
  const brands = ['Zara', 'H&M', 'Libas', 'Biba', 'Nykaa Fashion', 'Shein', 'Aurelia', 'Fabindia', 'Only', 'Vero Moda']
  const sizes = ['XS', 'S', 'M', 'L', 'XL', 'XXL']
  const colors = [
    { name: 'Black', hex: '#111' }, { name: 'White', hex: '#f5f5f5' },
    { name: 'Pink', hex: '#e91e8c' }, { name: 'Red', hex: '#e53935' },
    { name: 'Yellow', hex: '#fdd835' }, { name: 'Blue', hex: '#1565C0' },
    { name: 'Purple', hex: '#6a1b9a' }, { name: 'Green', hex: '#2e7d32' },
  ]
