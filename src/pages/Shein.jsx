...
export default function Shein() {
  ...
  useEffect(() => {
    fetch('/api/products?gender=Women&brand=Shein')
      .then(res => res.json())
      .then(data => {
        setProducts(data)
        setLoading(false)
        ...
        {!loading && !error && (
          <>
            {(activeCategory === 'All' || activeCategory === 'Dresses') && (
              <>
                <div className="section-header"><h2 className="section-title">Shein Dresses</h2></div>
            ...
            {(activeCategory === 'All' || activeCategory === 'T-Shirts') && (
              <>
                <div className="section-header"><h2 className="section-title">Shein T-Shirts</h2></div>
            ...
            {(activeCategory === 'All' || activeCategory === 'Jeans') && (
              <>
                <div className="section-header"><h2 className="section-title">Shein Jeans</h2></div>
