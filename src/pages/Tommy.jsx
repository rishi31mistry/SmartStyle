...
export default function Tommy() {
  ...
  useEffect(() => {
    fetch('/api/products?gender=Men&brand=Tommy%20Hilfiger')
      .then(res => res.json())
      .then(data => {
        setProducts(data)
        setLoading(false)
          ...
          {categories.map(cat => (
            <button
              ...
              style={{
                ...
                background: activeCategory === cat.name ? '#CC0000' : '#fff',
        ...
        {!loading && !error && (
          <>
            {(activeCategory === 'All' || activeCategory === 'T-Shirts') && (
              <>
                <div className="section-header"><h2 className="section-title">Tommy T-Shirts</h2></div>
            ...
            {(activeCategory === 'All' || activeCategory === 'Shirts') && (
              <>
                <div className="section-header"><h2 className="section-title">Tommy Shirts</h2></div>
            ...
            {(activeCategory === 'All' || activeCategory === 'Jeans') && (
              <>
                <div className="section-header"><h2 className="section-title">Tommy Jeans</h2></div>
