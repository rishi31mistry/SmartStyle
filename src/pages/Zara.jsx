...
export default function Zara() {
  ...
  useEffect(() => {
    fetch('/api/products?gender=Women&brand=Zara')
      .then(res => res.json())
      .then(data => {
        setProducts(data)
        setLoading(false)
  ...
  const visibleProducts = products.filter(
    (p) => !['/image/women/dress/d1.jpg', '/image/women/dress/d7.jpg'].includes(p.image)
  )
        ...
        {!loading && !error && (
          <>
            {(activeCategory === 'All' || activeCategory === 'Dresses') && (
              <>
                <div className="section-header"><h2 className="section-title">Zara Dresses</h2></div>
            ...
            {(activeCategory === 'All' || activeCategory === 'T-Shirts') && (
              <>
                <div className="section-header"><h2 className="section-title">Zara T-Shirts</h2></div>
            ...
            {(activeCategory === 'All' || activeCategory === 'Jeans') && (
              <>
                <div className="section-header"><h2 className="section-title">Zara Jeans</h2></div>
