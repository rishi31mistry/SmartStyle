...
export default function HMWomen() {
  ...
  useEffect(() => {
    fetch('/api/products?gender=Women&brand=H%26M')
      .then(res => res.json())
      .then(data => {
        setProducts(data)
        setLoading(false)
  ...
  const visibleProducts = products.filter(
    (p) => p.image !== '/image/women/dress/d16.jpg'
  )
        ...
        {!loading && !error && (
          <>
            {(activeCategory === 'All' || activeCategory === 'Dresses') && (
              <>
                <div className="section-header"><h2 className="section-title">H&M Dresses</h2></div>
            ...
            {(activeCategory === 'All' || activeCategory === 'T-Shirts') && (
              <>
                <div className="section-header"><h2 className="section-title">H&M T-Shirts</h2></div>
            ...
            {(activeCategory === 'All' || activeCategory === 'Jeans') && (
              <>
                <div className="section-header"><h2 className="section-title">H&M Jeans</h2></div>
