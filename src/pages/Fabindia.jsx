...
export default function Fabindia() {
  ...
  useEffect(() => {
    fetch('/api/products?gender=Women&brand=Fabindia')
      .then(res => res.json())
      .then(data => {
        setProducts(data)
        setLoading(false)
        ...
        {!loading && !error && (
          <>
            {(activeCategory === 'All' || activeCategory === 'Dresses') && (
              <>
                <div className="section-header"><h2 className="section-title">Fabindia Dresses</h2></div>
            ...
            {(activeCategory === 'All' || activeCategory === 'Tops') && (
              <>
                <div className="section-header"><h2 className="section-title">Fabindia Tops</h2></div>
            ...
            {(activeCategory === 'All' || activeCategory === 'Jeans') && (
              <>
                <div className="section-header"><h2 className="section-title">Fabindia Jeans</h2></div>
