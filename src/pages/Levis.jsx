...
export default function Levis() {
  ...
  useEffect(() => {
    fetch('/api/products?gender=Men&brand=Levi%27s')
      .then(res => res.json())
      .then(data => {
        setProducts(data)
        setLoading(false)
          ...
          {categories.map(cat => (
            <button
              ...
              style={{
                ...
                background: activeCategory === cat.name ? '#C8102E' : '#fff',
        ...
        {!loading && !error && (
          <>
            {(activeCategory === 'All' || activeCategory === 'T-Shirts') && (
              <>
                <div className="section-header"><h2 className="section-title">Levi's T-Shirts</h2></div>
            ...
            {(activeCategory === 'All' || activeCategory === 'Shirts') && (
              <>
                <div className="section-header"><h2 className="section-title">Levi's Shirts</h2></div>
            ...
            {(activeCategory === 'All' || activeCategory === 'Jeans') && (
              <>
                <div className="section-header"><h2 className="section-title">Levi's Jeans</h2></div>
