...
export default function Gap() {
  ...
  useEffect(() => {
    fetch('/api/products?gender=Men&brand=Gap')
      .then(res => res.json())
      .then(data => {
        setProducts(data)
        setLoading(false)
          ...
          {categories.map(cat => (
            <button
              ...
              style={{
                ...
                background: activeCategory === cat.name ? '#1C3461' : '#fff',
        ...
        {!loading && !error && (
          <>
            {(activeCategory === 'All' || activeCategory === 'T-Shirts') && (
              <>
                <div className="section-header">
                  <h2 className="section-title">Gap T-Shirts</h2>
                </div>
            ...
            {(activeCategory === 'All' || activeCategory === 'Shirts') && (
              <>
                <div className="section-header">
                  <h2 className="section-title">Gap Shirts</h2>
                </div>
            ...
            {(activeCategory === 'All' || activeCategory === 'Jeans') && (
              <>
                <div className="section-header">
                  <h2 className="section-title">Gap Jeans</h2>
                </div>
