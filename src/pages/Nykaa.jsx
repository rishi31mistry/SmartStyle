...
export default function Nykaa() {
  ...
  useEffect(() => {
    fetch('/api/products?gender=Women&brand=Nykaa%20Fashion')
      .then(res => res.json())
      .then(data => {
        setProducts(data)
        setLoading(false)
        ...
        {!loading && !error && (
          <>
            {(activeCategory === 'All' || activeCategory === 'Dresses') && (
              <>
                <div className="section-header"><h2 className="section-title">Nykaa Fashion Dresses</h2></div>
            ...
            {(activeCategory === 'All' || activeCategory === 'Tops') && (
              <>
                <div className="section-header"><h2 className="section-title">Nykaa Fashion Tops</h2></div>
            ...
            {(activeCategory === 'All' || activeCategory === 'Jeans') && (
              <>
                <div className="section-header"><h2 className="section-title">Nykaa Fashion Jeans</h2></div>
