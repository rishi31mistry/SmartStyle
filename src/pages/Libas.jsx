...
export default function Libas() {
  ...
  useEffect(() => {
    fetch('/api/products?gender=Women&brand=Libas')
      .then(res => res.json())
      .then(data => {
        setProducts(data)
        setLoading(false)
        ...
        {!loading && !error && (
          <>
            {(activeCategory === 'All' || activeCategory === 'Dresses') && (
              <>
                <div className="section-header"><h2 className="section-title">Libas Dresses</h2></div>
            ...
            {(activeCategory === 'All' || activeCategory === 'Tops') && (
              <>
                <div className="section-header"><h2 className="section-title">Libas Tops</h2></div>
            ...
            {(activeCategory === 'All' || activeCategory === 'Jeans') && (
              <>
                <div className="section-header"><h2 className="section-title">Libas Jeans</h2></div>
